...
<div class="d-flex flex-wrap container">
    ...
    <div class="item me-5 ms-2 my-4 d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="movie-info-inner5">
            <div class="button-background-parent6">
                <div class="button-background9"></div>
                <div class="mua-v9">MUA VÉ</div>
                <img class="frame-child15" alt="" src="./image/slat.png" />

                <img class="frame-child16" alt="" src="./image/slat.png" />

                <img class="frame-child17" alt="" src="./image/slat.png" />
            </div>
        </div>
    </div>
    <!-- </div> -->
