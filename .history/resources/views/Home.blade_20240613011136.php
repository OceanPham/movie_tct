...
<!-- Show dialog -->
<h1>oCEAN</h1>
<!-- <dialog id="movieNotFoundDialog"> -->
<!-- <div>
        <h2>Phim không tìm thấy</h2>
        <p>Xin lỗi, chúng tôi không thể tìm thấy phim bạn yêu cầu.</p> -->
<!-- <button onclick="dialog.close()">Đóng</button> -->
<!-- </div> -->
<!-- </dialog> -->


        <div class="modal fade" id="movieNotFoundDialog" tabindex="-1" aria-labelledby="movieNotFoundDialogLabel" aria-hidden="false">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="movieNotFoundDialogLabel">Thông Báo</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>SORRY Phim tìm kiếm không tồn tại</p>
                    </div>
