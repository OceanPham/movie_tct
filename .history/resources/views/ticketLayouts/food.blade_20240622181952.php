...
<div class="seating-chart">
    <nav class="nav-ticket">
        <p class="p-ticket"> <a class="a-ticket" href="{{ route('movie.index') }}">Trang chủ</a> > <a class="a-ticket" href="#" onclick="window.location.href = 'show';">Lịch chiếu</a> > <a class="a-ticket" href="#">Đặt vé Online</a> </p>
    </nav>
    <div class="food-div">
