...
<div class="modal" id="confirmModal">
    <div class="modal-content" id="modal-content-confirmTicket">
        <div id="header-modal-confirmTicket">
            ...
            <button type="button" class="fs-4" data-bs-dismiss="modal" onclick="window.location.href = 'food';" id="closeModal-thuong">
            <i style="margin-top: -30px !im;" class="fa-regular fa-circle-xmark" id="closeBackModal"></i>
            </button>
        </div>
