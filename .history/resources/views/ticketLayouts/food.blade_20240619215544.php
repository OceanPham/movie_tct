...
<div class="modal" id="confirmModal">
    <div class="modal-content" id="modal-content-confirmTicket">
        <div id="header-modal-confirmTicket">
            ...
            <button  style="margin-top: -30px;"  type="button" class="fs-4" data-bs-dismiss="modal" onclick="window.location.href = 'food';" id="closeModal-thuong">
            <iclass="fa-regular fa-circle-xmar !k" id="closeBackModal"></iclass=>
            </button>
        </div>
