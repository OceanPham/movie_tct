...
<div class="modal" id="confirmModal">
    <div class="modal-content" id="modal-content-confirmTicket">
        ...
        <button type="button" id="btn_toPay" onclick="window.location.href = 'food';">Tiến hành thanh toán</button>
    </div>
</div>
<script>
