...
<div class="notification d-flex flex-column">
    <div class="title_notify fs-2 ms-5 mt-2 d-flex">
        ...
        <img class="vector-icon1 me-3" alt="" src="{{ asset('image/icon_cancel.png') }}" id="vectorIcon" />
    </div>

    <div class="content_notify d-flex">
        <img class="icon_sorry me-0" loading="lazy" alt="" src="{{ asset('image/icon_sorry.png') }}" />
        <h4 class="phim-tm-kim">
