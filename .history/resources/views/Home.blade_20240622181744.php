...
<div class="nav_search fs-3 px-4 my-2">
    <p class=""> <a class="custom-link" href="{{ route('movie.index') }}">Trang chủ</a> > Tìm kiếm </p>
</div>

@if(count($movies_search)==0)
<!-- <div class="overlay hidden-overlay" id="overlay"></div> -->
<div class="overlay_pnhuy" id="overlay_pnhuy"></div>
<div class="notification_pnhuy d-flex flex-column">
    <div class="title_notify fs-3 ms-5 mt-2 d-flex">
        <b class="thng-bo">Thông Báo</b>
        <button type="button" style="margin-top: -25px; margin-right: 20px" class="fs-3 vector-Icon" data-bs-dismiss="modal" id="vectorIcon">
    ...
    <div class="ok-wrapper btn mt-4 mb-4" id="btn_cancel">
        <p class="text-white fw-bold fs-4 ok">Ok</p>
    </div>
</div>
@endif
...
@if(count($movies_search)==0)
<div class="notice d-flex flex-column justify-content-center align-items-center">
    <p class="fs-5"> Phim tìm kiếm không tồn tại</p>
</div>
@endif
...
<div class="d-flex flex-wrap container">
    ...
    <div class="item me-5 ms-2 my-4 d-flex flex-column justify-content-around align-items-center">
        <div class="img_movie mb-2">
            <img src="{{ asset('image/' . $movie->img . '.png') }}" alt="{{ $movie->name }}" class="img-fluid img_m">
        </div>
        <div class="name_movie text-center fw-bold mb-2">
...
<div class="">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000"> <!-- Set interval to 1500ms (1.5 seconds) -->
...
<div class="title text-center pt-2 fs-1 fw-bold border-top">
