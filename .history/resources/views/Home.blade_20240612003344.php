    ...
    <!-- <div class="container"> -->
        <div class="item me-5 ms-2 my-4 d-flex flex-column justify-content-center align-items-center">
            <div class="img_movie mb-2">
                <img <i class="fa fa-calculator" aria-hidden="true"></i> src="{{ asset('image/' . $movie->img . '.png') }}" alt="{{ $movie->name }}" class="img-fluid">
            </div>
            <div class="name_movie text-center fw-bold mb-2">
                <p>{{ $movie->name }}</p>
            </div>
            <button class="btn">
                <img src="{{ asset('image/btn_buy.png') }}" alt="{{ $movie->name }}" alt="">
            </button>
        </div>
    <!-- </div> -->
    @endforeach
