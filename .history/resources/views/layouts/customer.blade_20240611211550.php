                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('customer.home') }}">PHIM <span class="sr-only">(current)</span></a>
                            </li>
                            {{--<li class="nav-item active">
            <a class="nav-link" href="#">GIÁ VÉ <span class="sr-only">(current)</span></a>
        </li>--}}
                            {{-- <li class="nav-item active">
            <a class="nav-link" href="{{route('doans.index')}}">ĐỒ ĂN<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item active">
                            ...
                            <li class="nav-item active">
                                ...
                                <a class="nav-link" href="{{ route('tintucs.index') }}">TIN TỨC VÀ ƯU ĐÃI<span class="sr-only">(current)</span></a>

                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="{{route('quydinhs.index')}}">QUY ĐỊNH<span class="sr-only">(current)</span></a>
                            </li>
                        </ul>
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <button id="ButtonDangXuat" class="dropdown-item" type="submit">Đăng
                                        xuất</button>
                                    <a class="dropdown-item" href="{{route('khachhangs.show')}}">Thông tin cá nhân</a>
                                </div>
