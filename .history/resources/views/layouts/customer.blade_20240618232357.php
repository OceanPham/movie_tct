    ...
    <header>
        <div class="logo d-flex">
            ...
            <div class="d-flex nav-bar justify-content-center align-items-center text-center">
                <a class="nav-link-header" href="#">LICH CHIẾU<span class="sr-only">(current)</span></a>
                <a class="nav-link-header" href="">TIN TỨC</a>
                <a class="nav-link-header" href="">GIÁ VÉ<span class="sr-only">(current)</span></a>
            </div>
