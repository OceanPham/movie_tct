    ...
    <div class="container-fluid padding0">
        ...
        <header>
            <div class="logo d-flex">
                ...
                <div class="navbar navbar-expand-lg d-flex flex-column justify-content-center align-items-center text-center">
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="">TIN TỨC<span class=""></span></a>
                            </li>
                            <li class="nav-item">
