...
<body>
    ...
    <footer class="footer-bn-trng">
                <img class="mail-send-envelope-envelope-e-icon" alt=""
                    src="./public/mailsendenvelopeenvelopeemailmessageunopenedsealedclose.svg" />

                <img class="phone-android-phone-mobile-de-icon" alt=""
                    src="./public/phoneandroidphonemobiledevicesmartphoneiphone.svg" />
