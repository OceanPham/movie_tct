...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-iin8EQlHgIBgEE8cCf5kGKveN6rIq/EgYz7tjo3gZY7MDEH0Y3PoHQge/4u2PdRb" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-mjn1QgtUHpGnK1+8jxqvErMMlEGm8Y3rJiSdmg/CcMMYK70TqTMt7YzCwzX2kk5/" crossorigin="anonymous"></script>
    <script>
        ...
        setInterval(function() {
            carousel.next(); // Chuyển đến slide tiếp theo
        }, 1500); // Đặt thời gian tự động chuyển slide là 1500ms (1.5 giây)
    </script>
