        ...
        <header>
            ...
            <div class="header-container">
                <header class="header-wrapper">
                    <div class="header-bn-trng">
                        <div class="brand">
                            <div class="logo">
                                <div class="ni-tm-nhn">Nơi tầm nhìn không giới hạn</div>

                                <img class="pink-icon" alt="" src="./image/logo.png" />
                        ...
                        <div class="nav-container-wrapper">
                            <div class="nav-container">
                                <div class="nav-wrapper">
                                    <div class="navbar">
                                        <div class="nav-bar">
                                            <a class="lch-chiu">LỊCH CHIẾU</a>
                                            <a class="tin-tc">TIN TỨC</a>
                                            <a class="gi-v">GIÁ VÉ</a>
                                        </div>
                                        <div class="nav-bar1">
                                            <a class="lch-chiu1">LỊCH CHIẾU</a>
                                            <a class="tin-tc1">TIN TỨC</a>
                                            <a class="gi-v1">GIÁ VÉ</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="search-bar-wrapper">
                                    <div class="search-bar">
                                        <div class="tm-kim">
                                            ...
                                            <input class="tm-kim-child" placeholder="Tên phim" type="text" />
                                        ...
                                        <!-- <div class="tm-kim1">
                                            <div class="tm-kim-item"></div>
                                            <div class="tn-phim-wrapper">
                                                <div class="tn-phim">Tên phim</div>
                                            </div>
                                            <div class="tm-kim-inner" id="rectangle1"></div>
                    ...
                    <!-- <div class="movie-image-parent">
                        ...
                        <input class="tn-phim1" placeholder="Tên phim" type="text" />
                    </div> -->
                </header>
            </div>
            <div class="slide">
                <img class="slide-content-icon" alt="" src="./image/slide1.png" />

                <img class="slide-content-icon1" loading="lazy" alt="" src="./image/slide2.png" />

                <img class="slide-content-icon2" loading="lazy" alt="" src="./image/slide3.png" />
            </div> -->
            @yield('baner')
        </header>
        <!-- END: Header -->
