...
<body>
                ...
                <form action="{{route('movie.index')}}" method="GET">
                    <div class="inner-form">
                        <div class="input-field first-wrap">
                            <input name="movie_search" id="search" type="text" placeholder="Tên phim" />
                        </div>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-IHwe577yQWAiiW18t660zlle4rV4p9ktleF7E5yLq784q/zC8qR10y5g5zKU4dve0" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-ggQ6xUjF3rJ/tQj10j7l3RXw6L6s8E3DBqnqFKuR1o7j507j9RQ8p/u5r0I/Q6TU" crossorigin="anonymous"></script>
