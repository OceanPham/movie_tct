...
<body>
    ...
    <footer class="footer-bn-trng">
        <img class="mail-send-envelope-envelope-e-icon" alt="" src="./public/mailsendenvelopeenvelopeemailmessageunopenedsealedclose.svg" />

        <img class="phone-android-phone-mobile-de-icon" alt="" src="./public/phoneandroidphonemobiledevicesmartphoneiphone.svg" />

        <img class="logo-icon2" alt="" src="./public/logo@2x.png" />

        <div class="chm-sc-khch-hng-parent">
            <h2 class="chm-sc-khch">CHĂM SÓC KHÁCH HÀNG</h2>
            <div class="address-container">
                <p class="a-ch-ta-nh-container">
                    <span class="a-ch-ta-nh">Địa Chỉ: Tòa nhà 175 Tây Sơn, Đống Đa, Hà Nội</span>
                    <span class="hotline-19002099">Hotline: 19002099</span>
                    <span class="email-cskhtctcinemavn">Email: cskh@tctcinema.vn</span>
                </p>
            </div>
        </div>
        <div class="iu-khon-parent">
            <h2 class="iu-khon">ĐIỀU KHOẢN</h2>
            <h2 class="dmca-privacy-term-container">
                <p class="dmca">DMCA</p>
        ...
        <div class="kt-ni-vi-chng-ti-parent">
            <h2 class="kt-ni-vi">KẾT NỐI VỚI CHÚNG TÔI</h2>
            <img class="image-37-icon" loading="lazy" alt="" src="./public/image-37@2x.png" />
        </div>
    </footer>
